...
def _write_crossover_md(summary, valid, q, rejected, adjusted, group, ws, me) -> None:
    lines = [
        ...
        "묶음 안에서 통제되므로, 조업이 집중되는 시간대나 계절 추세가 결과에 섞이지 않습니다. 사고 전 한 시점만",
    ...
    lines += [
        ...
        "사고에서는 풍속이 유의하지 않았습니다. 기계 고장형 사고는 위험한 기상이 원인이라기보다, 출항과 조업이 늘어나는",
        "**잔잔하고 따뜻한 날**에 더 많이 발생합니다. 즉 사고 시점 기상과의 연관은 위험 신호가 아니라 활동·노출",
        "패턴이 반영된 결과로 해석했습니다. 사고종류 구성은 [accident_types.md](accident_types.md)에 정리했습니다.",
        "",
